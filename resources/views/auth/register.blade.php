				...
				<div class="card mt-5" style="background:none;border:none;">
					...
					<div class="card-body">
						<form method="POST" action="{{ route('register') }}">
							...
							<div class="form-group row">
								<label for="nb_participants" class="col-md-4 col-form-label text-md-right text-info" style=";line-height:1">nombre d'élèves participant <sup class="text-danger">*</sup><br /><span class="small font-italic" style="opacity:0.5">ce nombre peut être mis à jour à tout moment</span></label>
								<div class="col-md-6">
